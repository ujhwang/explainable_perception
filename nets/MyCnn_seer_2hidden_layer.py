...
class MyCnn(nn.Module):
    ...
    def __init__(self, model, finetune=False):
        ...
        self.rank_fc_1 = nn.Linear(self.cnn_size[1] * self.cnn_size[2] * self.cnn_size[3], 3172)
        self.relu = nn.ReLU()
        self.drop = nn.Dropout(0.3)
        self.hidden1 = nn.Linear(3172, 3172)
        self.hidden2 = nn.Linear(3172, 1586)
        self.rank_fc_out = nn.Linear(1586, 1)
